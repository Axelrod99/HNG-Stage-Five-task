import videoFrame from "../../assets/icon/video_frame.svg"
		...
		<section className="w-full flex justify-center py-10">
			<main className="w-11/12 flex flex-col gap-10 h-fit">
				...
				<section className="h-full grid grid-cols-1 md:grid-cols-2 gap-10">
					<Link to="/home/1" className="border border-gray-300 rounded-2xl p-4">
						...
						<span className="flex justify-between items-start pt-4">
							<span className="flex flex-col gap-3">
								<h1
									className="text-dark_black font-work_sans font-medium text-lg md:text-xl "
								>
